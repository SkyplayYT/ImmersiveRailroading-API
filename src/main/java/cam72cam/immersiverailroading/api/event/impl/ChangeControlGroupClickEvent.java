...
public class ChangeControlGroupClickEvent extends CancelableEvent<ChangeControlGroupClickEvent> {
    ...
    public ChangeControlGroupClickEvent(String name, float value, boolean pressed, UUID stockUUID, Player player) {
        this.name = name;
        this.value = value;
