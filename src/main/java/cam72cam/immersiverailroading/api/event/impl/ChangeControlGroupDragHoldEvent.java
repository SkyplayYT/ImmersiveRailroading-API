...
public class ChangeControlGroupDragHoldEvent extends CancelableEvent<ChangeControlGroupDragHoldEvent> {
    ...
    public ChangeControlGroupDragHoldEvent(String name, float value, boolean pressed, UUID stockUUID, Player player) {
        this.name = name;
        this.value = value;
